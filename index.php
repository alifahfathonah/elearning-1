...
<meta charset="utf-8">
	...
	<title>eLearning - Online Learning Platform</title>
	...
	<header id="head">
		<div class="container">
			<div class="banner-content">
				<p align="center" style="background-color: rgb(0,0,0);  background-color: rgba(0,0,0, 0.5); background-size: 200px; color: #FFF; font-size: 50px;font-family: 'Open Sans', sans-serif; font-weight: 900; margin: 200px;">ONLINE E-LEARNING PORTAL</p>
